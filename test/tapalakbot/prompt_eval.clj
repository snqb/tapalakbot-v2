...
(def category-scenarios
  [{:input "помещение под кофейню" :accept-ids [2067 2064 2065 2066 2068 96 781 782]}
   {:input "офис в аренду" :accept-ids [2068 2064 2065 2066 2067 209 79 200 201]}
   {:input "iphone 15" :accept-ids [110 1471 10180 130 1470 1472 1031 1032 1360 1361]}
